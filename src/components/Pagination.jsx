  ...
  return (
    <div className="flex justify-between">
      ...
      <div className="flex items-center w-2/5 justify-center bg-white rounded-md border-none shadow-lg">
        <select
          className="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none outline-none text-center focus:appearance-none active:appearance-none"
        >
