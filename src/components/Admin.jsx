...
function Admin() {
  ...
  return (
    <div className="overflow-auto w-full p-4 h-full flex flex-col sm:p-4 text-black">
        ...
        <div className="w-full h-full mb-4" key={elements._id}>
          <div className="border-b border-opacity-20 rounded-xl border-gray-700 bg-purple-300 flex justify-between px-10 items-center h-full">
            ...
            <div className="text-center">
              <AiFillDelete className="text-violet-900 cursor-pointer w-7 h-7 rounded-full" onClick={()=> dispatch(deleteProductAsync(elements.name))} />
            </div>
          </div>
        </div>
      ))}
